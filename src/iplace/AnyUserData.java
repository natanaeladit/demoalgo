...
public class AnyUserData {
    ...
    public static FakeResults fakeScanSimple() {
        return fakeSimple();
    }

    private static FakeResults fakeSimple() {
        FakeResults r = new FakeResults();
        ArrayList<LogRecord> latestScanList = new ArrayList<LogRecord>();

        latestScanList.add(new LogRecord("a8:bd:27:a7:24:33", -50));
        latestScanList.add(new LogRecord("a8:bd:27:a7:24:32", -50));
